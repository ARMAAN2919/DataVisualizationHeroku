function PlotGraph(year) { // function for slider to change years
  ...
  d3.csv(fileUrl, function (data) {
    ...
    /* Lines 139-162 adapted from Block by Michael Stanalands. 
    Major changes have been made http://bl.ocks.org/mstanaland/6100713 */  
    ...
    /* Idea inspired from d3-axis github */  
    ...
    /* Lines 206-213 adapted from Block by Sebastian Guitierrez. 
    Just the appending of the scatter plot chart https://bl.ocks.org/sebg/6f7f1dd55e0c52ce5ee0dac2b2769f4b */  
    ...
    /* Concept of legend and tooltips taken from Block
    by Michael Stanalands*/  
...
/* all type of functions used in all graphs learnt from w3
